...
export const PatientFormValidation = z.object({
  ...
  insuranceProvider: z
    ...
    .max(50, "O nome do plano deve ter no máximo 50 caracteres"),
  insurancePolicyNumber: z
    .string()
    .min(2, "O número da carteirinha deve ter pelo menos 2 caracteres")
  ...
  privacyConsent: z
    ...
    .default(false)
    .refine((value) => value === true, {
      message: "Você deve aceitar a política de privacidade para prosseguir",
    }),
});
